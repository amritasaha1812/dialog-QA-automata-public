...
parser.add_argument('--strict', action='store_true', help='enables strict matching of ans_list_full. Else, if subset of ans_list_full present, it passes',default=True)
