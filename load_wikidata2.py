...
with codecs.open('wikidata_short_1.json','r','utf-8') as data_file:
    wikidata = json.load(data_file)
print 'Successfully loaded wikidata1'

with codecs.open('wikidata_short_2.json','r','utf-8') as data_file:
...
with codecs.open('items_wikidata_n.json','r','utf-8') as data_file:
    item_data = json.load(data_file)
print 'Successfully loaded items json'

with codecs.open('comp_wikidata_rev.json','r','utf-8') as data_file:
    reverse_dict = json.load(data_file)
print 'Successfully loaded reverse_dict json'

with codecs.open('wikidata_fanout_dict.json','r','utf-8') as data_file:
    wikidata_fanout_dict = json.load(data_file)
print 'Successfully loaded wikidata_fanout_dict json'

wikidata_fanout_dict_list = pickle.load(open('wikidata_fanout_dict_list.pickle', 'rb'))
print 'Successfully loaded wikidata_fanout_dict_list pickle'

with codecs.open('child_par_dict_save.json','r','utf-8') as data_file:
    child_par_dict = json.load(data_file)
print 'Successfully loaded child_par_dict json'


with codecs.open('filtered_property_wikidata4.json','r','utf-8') as data_file:
...
for q in wikidata_remove_list:
    wikidata.pop(q,None)
# ************************************************************************
with codecs.open('wikidata_type_dict.json','r','utf-8') as f1:
    wikidata_type_dict = json.load(f1)

with codecs.open('wikidata_rev_type_dict.json','r','utf-8') as f1:
    wikidata_type_rev_dict = json.load(f1)

with codecs.open('par_child_dict.json','r','utf-8') as f1:
    par_child_dict = json.load(f1)

with codecs.open('child_par_dict_name_2_corr.json','r','utf-8') as f1:
...
with codecs.open('prop_obj_90_map5.json','r','utf-8') as data_file:
    sub_90_map = json.load(data_file) # for sub-based ques., contains object parents

with codecs.open('prop_sub_90_map5.json','r','utf-8') as data_file:
    obj_90_map = json.load(data_file) # for obj-based ques., contains subject parents

#******************************************************************************************************************
sub_90_map_rlist = []
for p in sub_90_map:
    if p not in sing_sub_annot_wh or p not in plu_sub_annot_wh:
        sub_90_map_rlist.append(p)

for p in sub_90_map_rlist:
    sub_90_map.pop(p, None)

obj_90_map_rlist = []

for p in obj_90_map:
    if p not in sing_obj_annot_wh or p not in plu_obj_annot_wh:
        obj_90_map_rlist.append(p)

for p in obj_90_map_rlist:
        obj_90_map.pop(p, None)
#******************************************************************************************************************
with codecs.open('child_par_dict_immed.json','r','utf-8') as data_file:
...
for x in ent_list_resolved:
    ...
    if child_par_dict_immed[x] not in par_child_dict:
        par_child_dict[child_par_dict_immed[x]] = [x]
    else:
        par_child_dict[child_par_dict_immed[x]].append(x)
...
for q in ent_list_discard:
    ...
    if par_q is not None and par_q in par_child_dict:
        par_child_dict[par_q].remove(q)
